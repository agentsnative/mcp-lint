...
export const qual002 = {
    ...
    check(context) {
        ...
        if (!hasToolRegistration(content))
            return [];
        if (/destructiveHint\s*:\s*(?:true|false)|idempotentHint|openWorldHint|readOnlyHint\s*:\s*true|(?:dry_run|preview)[\s\S]{0,80}default\s*:\s*true|operatorApproval/i.test(content))
            return [];
...
//# sourceMappingURL=qual-002.js.map