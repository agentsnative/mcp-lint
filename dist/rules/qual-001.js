...
export const qual001 = {
    ...
    check(context) {
        ...
        for (const check of checks) {
            if ((check.subtype === "unconstrained_object" || check.subtype === "no_required") && !hasHandlerFieldUse(content))
                continue;
            if (check.subtype === "parameterless_tool_accepts_any_object" && hasHandlerFieldUse(content))
                continue;
...
//# sourceMappingURL=qual-001.js.map