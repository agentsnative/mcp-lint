...
export const sec003a = {
    ...
    check(context) {
        ...
        if (!hasHttpServer(content) || /stdio/i.test(content) && !hasMcpHttpRoute(content))
            return [];
        if (/(?:127\.0\.0\.1|localhost|::1)/i.test(content) && !/(?:0\.0\.0\.0|["'`]\*["'`]|["'`]::["'`])/.test(content))
            return [];
...
//# sourceMappingURL=sec-003a.js.map